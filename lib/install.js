...
module.exports = function install(){
	...
	return gladys.utils.sql('select language from user where role=\'admin\' order by id')
		...
		.then(() => {
			if((typeof gladys.param.getValue(shared.gladysSpeakerName) == 'undefined') && gladys.param.getValue(shared.gladysSpeakerValue) == null) {
			var param = {
		...
		.then(() => {
			if((gladys.param.getValue(shared.gladysMicrophoneName) == 'undefined') && gladys.param.getValue(shared.gladysMicrophoneValue) == null) {
			var param = {
