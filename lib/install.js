...
module.exports = function install(){
	...
	return gladys.utils.sql('select language from user where role=\'admin\' order by id')
		...
		.then(() => {
			if((typeof shared.gladysSpeakerName == 'undefined') && shared.gladysSpeakerName == null) {
			var param = {
		...
		.then(() => {
			if((typeof shared.gladysMicrophoneName == 'undefined') && shared.gladysMicrophoneName == null) {
			var param = {
